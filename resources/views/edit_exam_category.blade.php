            ...
            <div class="animated fadeIn">
                <div class="row ">                               
                    <div class="col-xs-6 col-sm-6   ">
                        <div class="card">
                        <form action="{{route('exam_category.update',[$category->id])}}" class="centered" name='form1' method='post'>
                        @csrf
                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="examcategory" value="{{$category->category}}" placeholder="enter new exam category">
                                    </div>                                   
                                </div>
                                <br>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="examtime" value="{{$category->exam_time_in_minutes}}" placeholder="enter time in minutes">
                                    </div>                                     
                                </div>
                                <br>
                                <div class="form-group">
                                   <input class="btn btn-primary" type = "submit" name = "submit" value="Add edit category">
