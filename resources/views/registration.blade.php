                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <div class="panel-body">
                                <form role="form" action="studentregister" method="post" id="login-form" autocomplete="off">
                                @csrf
                                    ...
                                    <br>
                                    <input type="submit" name="Register" id="btn-login" class="btn btn-custom btn-lg btn-primary" value="Register"> &nbsp;&nbsp;&nbsp;<span> <button class="btn btn-danger"><a style="color:white " href="registerteacher">Register as Teacher</a></button></span>
                                </form>
                            </div><!-- Body-->
                        </div>
                    </div>
